<template>
  ...
  >
    ...
    <v-container fluid class="fm-body d-flex flex-row pb-0">
      <v-row>
        ...
        <template v-else-if="windowsConfig === 2">
          <folder-tree class="col pa-0" style="max-width:300px;"></folder-tree>
          <left-manager class="col px-0 pb-0" manager="left"></left-manager>
        </template>
